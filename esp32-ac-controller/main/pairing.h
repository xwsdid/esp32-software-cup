...
#define PAIR_NVS_CONFIG_VERSION  3   /* v3: 强制默认MQTT+SM4启动 */
#define PAIR_NVS_KEY_CFG_VER    "cfgver"
...
void pairing_factory_reset(void);  /* 擦除NVS配网数据并重启 */
